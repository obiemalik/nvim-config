...
vim.cmd(
    'command! -nargs=1 SetColorScheme lua require("core/themes/colors").SetColorScheme(<f-args>)'
)
vim.cmd(
    'command! ResetColorScheme lua require("core/themes/colors").ResetColorScheme()'
)
vim.cmd(
    'command! ColorSchemePicker lua require("core/themes/colors_picker").show_scheme_picker()'
)
