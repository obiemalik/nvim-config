...
function StatusLine:get_components()
    ...
    local comps = {
        ...
        -- Monorepo scope indicator (WKS = workspace/monorepo root, PRJ = sub-package)
        workspace = {
            scope = {
                provider = function()
                    ...
                    return Workspace.is_local_workspace and " PRJ " or " WKS "
                end,
                hl = function()
                    local ok, Workspace = pcall(require, "utils.workspace")
                    local is_local = ok and Workspace.is_local_workspace
                    return {
                        fg = "bg",
                        bg = is_local and "orange" or "skyblue",
                        style = "bold",
                    }
                end,
                right_sep = " ",
    ...
    table.insert(components.active[1], comps.workspace.scope)
