...
return packer.startup(function(use)
  ...
  --use { 'williamboman/mason.nvim', config = function() require('mason').setup() end }          -- LSP Config UI
  ...
  use { 'jose-elias-alvarez/typescript.nvim', config = function() require('typescript').setup() end }
